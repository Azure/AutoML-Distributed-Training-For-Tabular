...
def get_prs_args(
    ...
    :param time_series_id_columns: The names of columns used to uniquely indentify a timeseries.
    ...
    prs_args.append(time_column_name)
    prs_args.append("--time_series_id_columns")
    prs_args.extend(time_series_id_columns)
    if partition_column_names:
        prs_args.append("--partition_column_names")
        prs_args.extend(partition_column_names)
